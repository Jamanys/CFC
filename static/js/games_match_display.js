...
const teamLogos = {
    ...
    LEI: "https://raw.githubusercontent.com/luukhopman/football-logos/master/logos/England%20-%20Premier%20League/Brighton%20%26%20Hove%20Albion.png",
...
function match_get_info(select){
    ...
    fetch("../static/csv/CFC GPS Data.csv")
        ...
        .then(data => {
            ...
            let output = `<div id="F-game-title"><h1>NEXT GAMES : </h1></div>
            <div id="F-game-cards">  `
